  ...
  movePlayer()
   ...
   if(c2.isTouching(player) && gameState==="PLAY"){
    ...
    bg.addImage(gameOverImage)
        ...
        foodGroup.setVisibleEach(false)
        sGroup.setVisibleEach(false)
        text("Virus Fighter Won",460,500)
...
function borders(){
    ...
    b17=createSprite(200,410,200,10)
    ...
    b22=createSprite(1000,350,200,10)
    b23=createSprite(1000,280,200,20)
    b24=createSprite(1000,410,200,10)
    b25=createSprite(355,670,310,20);
    b26=createSprite(850,670,310,20)
    b27=createSprite(390,640,35,85)
    b28=createSprite(815,640,35,83)
    b29=createSprite(450,280,125,30)
    b30=createSprite(765,285,145,20)
    b31=createSprite(250,215,115,30)
    b32=createSprite(950,215,110,20)
    b33=createSprite(950,145,115,35)
    b34=createSprite(760,140,125,35)
    b35=createSprite(450,140,130,35)
    b36=createSprite(250,145,115,35)
    b37=createSprite(950,540,110,20)
    ...
    //seee
    b45=createSprite(285,300,25,60)
    b46=createSprite(285,450,15,60)
    b47=createSprite(820,450,35,75)
    b48=createSprite(385,290,35,160)
    b49=createSprite(810,290,35,160)
    b50=createSprite(910,450,15,60)
    b51=createSprite(910,310,15,60)
    b52=createSprite(530,340,70,20)
    
    b53=createSprite(690,340,70,20)
    b54=createSprite(385,450,36,75)
